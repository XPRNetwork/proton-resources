<template>
  <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mb-10">
    <h2 class="text-lg mb-4 leading-6 font-medium text-neutral-900">Bot Tier</h2>
    ...
    <div class="sm:hidden">
      ...
      <select
        id="tabs"
        name="tabs"
        class="block w-full focus:ring-indigo-500 focus:border-indigo-500 border-neutral-300 rounded-md"
