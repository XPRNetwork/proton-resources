  ...
  <div class="mt-8">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-2 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        <OverviewCard title="Transactions per day" text="1,000"/>
        <OverviewCard title="Transactions per month" text="30,000"/>
        <OverviewCard title="Transactions per year" text="365,000"/>
      </div>
    </div>
